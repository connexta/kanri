...
export function isSourceConfiguration(
...
export const SourceFactoryIds = [
  'Confluence_Connected_Source',
  ...
  'Harvested_Source',
  'Isri_Wfs_v110_Federated_Source',
  'OpenSearchSource',
  'Wfs_v110_Federated_Source',
  'Wfs_v2_0_0_Federated_Source',
]

export function isSourceFactoryId(fpid?: string) {
  if (fpid === undefined) {
    return false
  }
  return (
